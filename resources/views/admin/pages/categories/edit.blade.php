            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <x-adminlte-input name="title" label="Название продукта" value="{{$category->title}}" placeholder="Введите название продукта..." label-class="text-lightblue">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <x-adminlte-text-editor name="description" :config="$config">{{$category->description}}</x-adminlte-text-editor>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="preview cover">
                                <div class="thumb-wrap">
                                    <img src="{{\Storage::url($category->cover_link)}}" class="img-thumbnail">
                                    <div class="controls">
